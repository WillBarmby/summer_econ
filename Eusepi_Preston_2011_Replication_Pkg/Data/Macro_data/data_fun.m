...
%% Ramey adj. series
data1 = [real_percapita_gdp_22;real_private_cons_22;real_percapita_inv_22;productivity_1;real_wage_22];

data_growth = data1(:,2:end)-data1(:,1:end-1); % one observation missing

data_level = [hours_percapita_22(2:end);caput(2:end-4)];
...
data_level = [hours_percapita_NBS(2:end);caput(2:end-4)];
