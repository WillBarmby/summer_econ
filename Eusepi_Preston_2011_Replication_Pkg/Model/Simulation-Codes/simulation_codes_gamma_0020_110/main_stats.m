...
%     acorr_w1,acorr_w4,acorr_rk1,acorr_rk4,acorr_R1,acorr_R3] = bus_cycle_stats_fun(not,epsZ);
...
[Moments_level_detr,Moments_growth,Auto_corr_growth,...
    ...
    STD_var_wrk,w_auto,rk_auto] = bus_cycle_stats_fun(not,epsZ);
