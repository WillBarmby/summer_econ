...
% a 40-quarter horizon, and a one-percentage-point technology innovation.
% The current NK technology-level shock is explicitly i.i.d.
config=learning_comparison_config();
config.nk_technology_persistence=0;

output_dir=fullfile(ir_dir,'artifacts','comparisons', ...
    'technology_growth_shock_1pct');
