// Verification-only Euler-equation representation of the E&P benchmark.
// This model checks the shared rational-expectations structural solution.
// It is not the production infinite-horizon learning model.
