...
result.summary = summarize_learning_results({simulation}, ...
    {'nk_risk_premium_ee'},result.quantity_names,config.plot_periods);
result = standardize_artifact(result, ...
    ['Does one-step EE learning materially change the NK response to an IID ' ...
    'one-percentage-point risk-premium innovation when technology shocks are zero?'], ...
