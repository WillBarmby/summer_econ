...
[artifact.output_files,artifact.summary] = ...
    save_ep_ee_consumption_audit(artifact,output_dir);
artifact = standardize_artifact(artifact, ...
    ['Does directly learning a subjective consumption equation materially ' ...
    'change benchmark EE IRFs relative to keeping consumption forecasts at RE?'], ...
    struct('standardized_innovations',{{'draw','simulation_period'}}, ...
    'results',{{'variant'}}, ...
    'summary_rates',{{'variant','status'}}, ...
    'summary_conditional_irf',{{'variant','quantity','period'}}, ...
    'summary_draw_level_irf',{{'draw','quantity','period','variant'}}, ...
    'summary_direct_minus_archive_irf',{{'draw','quantity','period'}}));
