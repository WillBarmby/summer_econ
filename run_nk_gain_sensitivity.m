...
sensitivity = struct('experiment','nk_gain_sensitivity','config',config, ...
    ...
    'output_files',struct());
sensitivity.summary = struct( ...
    'technology',summarize_gain_grid({technology_results},{'nk_ee'},gains, ...
    sensitivity.technology_quantity_names,config.plot_periods), ...
    'risk_premium',summarize_gain_grid({risk_results},{'nk_ee'},gains, ...
    sensitivity.risk_quantity_names,config.plot_periods));
sensitivity = standardize_artifact(sensitivity, ...
    ['How does the learning gain affect NK EE amplification under separate ' ...
    'technology and risk-premium shocks?'],struct( ...
    'standardized_innovations',{{'draw','simulation_period'}}, ...
    'technology_results',{{'gain'}},'risk_results',{{'gain'}}, ...
    'technology_summary_maximum_wedge',{{'specification','gain','quantity'}}, ...
    'risk_premium_summary_maximum_wedge',{{'specification','gain','quantity'}}));
