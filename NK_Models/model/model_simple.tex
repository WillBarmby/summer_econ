...
\fancyhead[C]{\textsc{\color{Gray} Gavin et al: The ZLB, the Dual Mandate, and Unconventional Dynamics}}
...
\begin{gather}
  c_t+i_t+k_{t-1}+b_t=w_tn_t+r_t^kk_{t-1}+r_{t-1}b_{t-1}/\pi_t+d_t, \label{bc2}\\
