...
comparison.summary = summarize_gain_grid( ...
    {ep.ee_results,ep.ih_results,nk_results}, ...
    {'ep_ee','ep_ih','nk_ee'},gains,comparison.quantity_names, ...
    config.plot_periods);
comparison = standardize_artifact(comparison, ...
    ['Is gain sensitivity common to E&P EE, E&P IH, and NK EE under the ' ...
    'same technology shock, or concentrated in one formulation?'],struct( ...
    'standardized_innovations',{{'draw','simulation_period'}}, ...
    'ep_ee_results',{{'gain'}},'ep_ih_results',{{'gain'}}, ...
    'nk_ee_results',{{'gain'}}, ...
