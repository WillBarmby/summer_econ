...
artifact = struct('experiment','initialization_robustness', ...
    ...
    'results',{results},'summary',struct(),'output_files',struct());
artifact.summary = summarize_initialization_robustness(artifact);
artifact = standardize_artifact(artifact, ...
    ['How much do reported learning IRFs depend on starting at exact RE rather ' ...
    'than half-RE coefficients, and how quickly does training remove that dependence?'], ...
    struct('training_standardized_innovations',{{'draw','training_period'}}, ...
    'ir_standardized_innovations',{{'draw','period'}}, ...
    'results',{{'specification','initialization','training_horizon'}}, ...
    'summary_rates',{{'specification','initialization','training_horizon','status'}}, ...
    'summary_learning_minus_re_irf',{{'draw','specification','initialization', ...
    'training_horizon','quantity','period'}}, ...
    'summary_initialization_difference_irf',{{'draw','specification', ...
    'training_horizon','quantity','period'}}, ...
    'summary_scalar_effects',{{'specification','training_horizon','quantity'}}));
