// Eusepi-Preston RBC model for paper-faithful one-period Euler learning.
// Source: the verified ep_ee_paper.mod at Git tag ep-verification-v1.
// Variables are percentage deviations from the balanced-growth path.
